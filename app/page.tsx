	...
	return (
		<div className="flex flex-col min-h-screen">
			...
			<main className="flex flex-col w-full">
				...
				<section className="min-h-screen relative" ref={sectionRef}>
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
					<div className="text-center mb-12">
					<span className="px-3 py-1 border rounded-full shadow-[inset_0_-7px_11px_#7AC6D2]/20 text-[0.92rem] border-[#3D90D7]/60 inline-flex text-white bg-black/20 backdrop-blur-md mx-auto">
						Projects
					</span>
