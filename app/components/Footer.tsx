export default function Footer() {
  return (
    <footer className="w-full border-t border-zinc-800 backdrop-blur-lg bg-transparent mt-auto">
        ...
        <div className="flex flex-col items-center sm:items-start sm:flex-row sm:justify-between gap-4">
          <div className="flex flex-col items-center sm:items-start gap-2 w-full sm:w-auto">
            <p className="text-zinc-400 text-sm">
              © {new Date().getFullYear()} Cobalt. All rights reserved.
            </p>
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <a
                  href="https://github.com/motorphobe/Cobalt"
                  className="text-sm text-zinc-400 hover:text-[#3D90D7] transition-colors flex items-center gap-2"
                >
                  GitHub
                </a>
